...
const positiveQuests = [
  ...
  `You uncover an ancient alien star map on the planet Makhaar. Move FORWARD in your adventure by 5 light years! 🗺️`,
  ...
  `BeatriX D/Headshot joins you: “An anti-matter sniper rifle and a beer?! Wow, I'm totally in!”. Move FORWARD by 7 light years! 🍻`,
...
const negativeQuests = [
  // 5 Points Quests
  `Oh no, an holographic trap! That spaceship wasn’t real. You’ve wasted so much fuel to follow it. Move BACK by 5 light years! ⛽️`,
  `You contract a rare type of space virus, requiring immediate quarantine. Move BACK by 5 light years! 🦠`,
  `You activate a space-time dilation field by mistake, moving BACK by 5 light years! ⏳`,
  `Your energy reserves run critically low, requiring you to move BACK of 5 light years to recharge! 🪫`,
